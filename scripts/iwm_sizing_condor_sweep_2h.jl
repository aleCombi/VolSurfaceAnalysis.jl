...
SYMBOL              = "IWM"
START_DATE          = Date(2022, 8, 1)   # IWM 0DTE only reliable post-Aug 2022
...
run_dir = joinpath(@__DIR__, "runs", "iwm_sizing_condor_sweep_2h_$run_ts")
mkpath(run_dir)
...
# =============================================================================
# Per-month Sharpe — focus on best (wing, policy) combo
# =============================================================================
