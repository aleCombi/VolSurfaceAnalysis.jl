...
#
# Test: does intraday spot-path information predict realized PnL of a fixed (QQQ intraday)
...
run_dir = joinpath(@__DIR__, "runs", "logsig_ic_2ch_QQQ_intraday_late_$run_ts")
mkpath(run_dir)
