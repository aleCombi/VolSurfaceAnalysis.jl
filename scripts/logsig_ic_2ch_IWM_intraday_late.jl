...
#
# Test: does intraday spot-path information predict realized PnL of a fixed (IWM intraday)
...
run_dir = joinpath(@__DIR__, "runs", "logsig_ic_2ch_IWM_intraday_late_$run_ts")
mkpath(run_dir)
