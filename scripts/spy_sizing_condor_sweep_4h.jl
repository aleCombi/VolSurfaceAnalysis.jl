...
EXPIRY_INTERVAL     = Hour(4)            # 4h tenor
SPREAD_LAMBDA       = 0.7
RATE                = 0.045
DIV_YIELD           = 0.013
...
TRAIN_WINDOW_DAYS   = 365   # smaller because intraday data is denser
TEST_WINDOW_DAYS    = 90
STEP_DAYS           = 90
MAX_SIZE            = 2.0
...
run_dir = joinpath(@__DIR__, "runs", "spy_sizing_condor_sweep_4h_$run_ts")
mkpath(run_dir)
